$(function(){
    ...
    $("footer h3").click(function(){
        ...
        outabout='<div id="p_ssa"><ul><li id="aboutt"><h3>关于 MiEase.com 生成安全密码</h3></li><li class="aboutl">用记忆中的关键词生成无意义密码。</li><li class="aboutl">纯JS程序，MD5多重加密，可存至本地运行。</li><li class="aboutl">密码关键词为空时，生成随机密码。</li><li class="aboutl">附加关键词可用于区分不同的用途。</li><li class="aboutl">源码托管：<a href="https://github.com/seatop/miease.com" target="_balnk">github.com/seatop/miease.com</a></li><li class="aboutl">使用反馈：<a href="https://support.qq.com/product/308470" target="_balnk" >support.qq.com/product/308470</a></li><li class="aboutl">MiEase.com 会始终运行于 GitHub Pages.</li><li class="aboutl">本程序仅供参考，不承担任何风险与责任。</li></ul></div>';
